onEvent('item.registry', event => { 
    event.create('immortuos_eggs_sample_vial').displayName('Immortuos eggs sample vial')
    event.create('immortuos_eggs_sample').displayName('Immortuos eggs sample')
    event.create('dragon_breath_dummy').displayName('Dragon breath')
    event.create('drowned_dummy').displayName('Drowned zombie')
    event.create('crab_dummy').displayName('Crab')
    event.create('quartz_crab_dummy').displayName('Quartz crab')
    event.create('silverfish_dummy').displayName('Silverfish')
    event.create('redstone_silverfish_dummy').displayName('Redstone bug')
    event.create('iron_cogwheel').displayName('Iron cogwheel')
    event.create('iron_large_cogwheel').displayName('Iron cogwheel')
    event.create('iron_large_cogwheel_cast').displayName('Large gear cast')
    event.create('iron_large_cogwheel_sand_cast').displayName('Large gear sand cast')
    event.create('iron_large_cogwheel_red_sand_cast').displayName('Large gear red sand cast')
    event.create('kinetic_mechanism').displayName('Kinetic mechanism')
    event.create('mechanism_base').displayName('Kinetic mechanism')
    event.create('incomplete_kinetic_mechanism', 'create:sequenced_assembly').displayName('Incomplete kinetic mechanism').texture("kubejs:item/incomplete_kinetic_mechanism")
